...
class HireHistoryList extends StatelessWidget {
  HireHistoryList({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        final HireHistoryInfo info = controller.listItems[index];
        return Stack(
          children: [
            ...
            Visibility(
              visible: !StringHelper.isEmptyString(info.typeName ?? ""),
              child: Align(
                alignment: Alignment.topLeft,
                child: TextViewWithContainer(
                  margin: const EdgeInsets.only(left: 34, top: 0),
                  text: StringHelper.capitalizeFirstLetter(info.typeName ?? ""),
