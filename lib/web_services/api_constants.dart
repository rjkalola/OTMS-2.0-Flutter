class ApiConstants {
  ...
  static String deleteFeed = '$appUrl/delete-feed';
  ...
  static String certificatesReplace = '$appUrl/certificates/replace';
  ...
  //Hire products
  static String getHireProducts = '$appUrl/product-tools/get';
