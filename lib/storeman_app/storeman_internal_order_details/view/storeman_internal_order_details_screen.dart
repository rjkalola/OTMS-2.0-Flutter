...
class StoremanInternalOrderDetailsScreen extends StatefulWidget {
  ...
  @override
  State<StoremanInternalOrderDetailsScreen> createState() => _StoremanInternalOrderDetailsScreenState();
}

class _StoremanInternalOrderDetailsScreenState extends State<StoremanInternalOrderDetailsScreen> {
                      ...
                      child: Row(
                        children: [
                          ...
                          if (controller.status.value ==
                              AppConstants.internalOrderStatus.delivered)
                            OutlinedButton(
                              onPressed: () {
                                FocusManager.instance.primaryFocus?.unfocus();
                                showDialog(
                                  ...
                                  builder: (context) => OrderStatusAlertDialog(
                                    title: 'Return Order ${controller.orderDetails[0].orderId ?? ""}',
                                    ...
                                    onConfirm: () {
                                      controller.updateOrderStatus(8,"");
                          ...
                          //Cancel button
                        if (controller.status.value ==
                    AppConstants.internalOrderStatus.newOrder || controller.status.value ==
                            AppConstants.internalOrderStatus.collected || controller.status.value ==
                            AppConstants.internalOrderStatus.ready || controller.status.value ==
                        AppConstants.internalOrderStatus.preparing || controller.status.value ==
                            AppConstants.internalOrderStatus.readyToDeliver)
                          OutlinedButton(
                            onPressed: () {
                              FocusManager.instance.primaryFocus?.unfocus();
                              showDialog(
                    ...
                    PrimaryButton(
                      ...
                      onPressed: () {
                        ...
                        showDialog(
                          context: context,
                          builder: (context) => OrderStatusAlertDialog(
                            title: 'Confirm Order ${controller.orderDetails[0].orderId ?? ""}',
                            description: "Are you sure you want to mark this order as ready for Collect?",
                            showTextField: false,
                      ...
                      PrimaryButton(
                        ...
                        onPressed: () {
                          ...
                          showDialog(
                            ...
                            builder: (context) => OrderStatusAlertDialog(
                              title: 'Confirm Order ${controller.orderDetails[0].orderId ?? ""}',
                              description: "Are you sure you want to mark this order as out for delivery?",
                              showTextField: false,
                              confirmText: "confirm".tr,
                              confirmColor: Colors.green,
                              onConfirm: () {
