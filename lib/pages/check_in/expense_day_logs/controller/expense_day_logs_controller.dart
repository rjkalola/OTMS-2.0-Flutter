...
import 'package:belcka/pages/check_in/expense_day_logs/controller/expense_day_logs_repository.dart';
...
class ExpenseDayLogsController extends GetxController
    implements MenuItemListener {
  final RxBool isLoading = false.obs,
      isInternetNotAvailable = false.obs,
      isMainViewVisible = true.obs;
  final RxInt selectedDateFilterIndex = (1).obs;
  final _api = ExpenseDayLogsRepository();
  ...
  void onInit() {
    ...
    getExpenseDayLogsApi(true);
  }

  void getExpenseDayLogsApi(bool isProgress) {
    isLoading.value = isProgress;
    Map<String, dynamic> map = {};
    map["user_id"] = userId;
    map["date"] = date;

    _api.getExpenseDayLogs(
      data: map,
