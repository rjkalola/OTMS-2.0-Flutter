...
class UserCheckInPhotosBeforeColors {
  UserCheckInPhotosBeforeColors._();

  static const Color accent = Color(0xFF6A5BFC);
  static const Color added = Color(0xFF32A852);

  static Color iconBackground(BuildContext context) {
    return accent.withOpacity(ThemeConfig.isDarkMode ? 0.22 : 0.12);
  }

  static Color takePhotoFill(BuildContext context) {
    return accent.withOpacity(ThemeConfig.isDarkMode ? 0.14 : 0.06);
  }

  static Color takePhotoCircleFill(BuildContext context) {
    return accent.withOpacity(ThemeConfig.isDarkMode ? 0.24 : 0.14);
  }

  static Color addedFill(BuildContext context) {
    return added.withOpacity(ThemeConfig.isDarkMode ? 0.16 : 0.06);
  }
...
class UserCheckInPhotosBeforeSection extends StatelessWidget {
  UserCheckInPhotosBeforeSection({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final hasPhotos = controller.listBeforePhotos.isNotEmpty;
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Container(
                  ...
                  height: 40,
                  decoration: BoxDecoration(
                    color: UserCheckInPhotosBeforeColors.iconBackground(context),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'take_photo_before_starting_job'.tr,
                        style: TextStyle(
                          fontSize: 13,
            ...
            GestureDetector(
              onTap: controller.onSelectCommonBeforePhotos,
