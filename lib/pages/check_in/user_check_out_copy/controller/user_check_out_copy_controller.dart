...
import 'package:belcka/pages/check_in/user_check_out_copy/controller/user_check_out_copy_repository.dart';
...
import 'package:belcka/pages/check_in/user_check_out_copy/view/widgets/user_check_out_copy_update_progress_sheet.dart';
...
class UserCheckOutCopyController extends GetxController
  ...
  final _api = UserCheckOutCopyRepository();
  ...
  void showUpdateProgressSheet(TypeOfWorkResourcesInfo info, int index) {
    ...
    showModalBottomSheet<void>(
      ...
      isDismissible: true,
      useSafeArea: true,
      builder: (_) => UserCheckOutCopyUpdateProgressSheet(info: info, index: index),
    );
  }
  ...
  Future<void> typeOfWorkDetails(
    ...
    if (StringHelper.isEmptyString(checkLogInfo.value.checkoutDateTime)) {
      showUpdateProgressSheet(info, index);
      return;
    }
