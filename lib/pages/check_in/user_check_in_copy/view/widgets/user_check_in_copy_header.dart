...
class UserCheckInCopyHeaderBar extends StatelessWidget {
  UserCheckInCopyHeaderBar({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => Padding(
        ...
        child: Row(
          children: [
            UserCheckInCopyBackButton(onPressed: () => Get.back()),
            const Spacer(),
...
class UserCheckInCopyHeaderContent extends StatelessWidget {
  const UserCheckInCopyHeaderContent({super.key});
...
class UserCheckInCopyBackButton extends StatelessWidget {
  const UserCheckInCopyBackButton({super.key, required this.onPressed});
