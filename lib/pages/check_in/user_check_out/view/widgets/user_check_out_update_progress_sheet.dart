...
class UserCheckOutUpdateProgressSheet extends StatefulWidget {
  const UserCheckOutUpdateProgressSheet({
    super.key,
    required this.info,
    required this.index,
  });
  ...
  @override
  State<UserCheckOutUpdateProgressSheet> createState() =>
      _UserCheckOutUpdateProgressSheetState();
}

class _UserCheckOutUpdateProgressSheetState
    extends State<UserCheckOutUpdateProgressSheet> {
  final controller = Get.find<UserCheckOutController>();
      ...
      children: [
        ...
        Padding(
          ...
          child: Obx(() {
            ...
            return UserCheckOutTakePhotoButton(
              hasPhoto: hasPhoto,
              fullWidth: true,
