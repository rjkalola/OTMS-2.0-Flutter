                        ...
                        return InkWell(
                          ...
                          child: Stack(
                            ...
                            children: [
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.center,
                                        children: [
                                          Text(controller.items[index].title, style: TextStyle(fontWeight: FontWeight.w600,
                                            fontSize: 16,),
                                            softWrap: false,
                                            overflow: TextOverflow.ellipsis,
                                            maxLines: 2,),
                                          if (controller.items[index].subtitle.isNotEmpty)
                                            Text(controller.items[index].subtitle, style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w500,
                                              fontSize: 15,),
                                              softWrap: true,
                                              overflow: TextOverflow.ellipsis,
                                              maxLines: 1,),
                              ...
                              if ((controller.items[index].badge != null) && ((controller.items[index].badge ?? 0) > 0))
                              Positioned(
                                top: -6,
                                right: 0,
                                child: Container(
