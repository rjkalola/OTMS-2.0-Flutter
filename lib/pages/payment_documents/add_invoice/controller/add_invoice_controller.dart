...
class AddInvoiceController extends GetxController
  ...
  final invoiceDateController = TextEditingController().obs;
  ...
  final _api = AddInvoiceRepository();
  ...
  void onInit() {
    ...
    if (arguments != null) {
      invoiceId.value = arguments[AppConstants.intentKey.ID] ?? 0;
  ...
  void addInvoiceApi() async {
    Map<String, dynamic> map = {};
    map["user_id"] = userId;
    map["company_id"] = ApiConstants.companyId;
    map["invoice_number"] = StringHelper.getText(invoiceNumberController.value);
    map["invoice_date"] = StringHelper.getText(invoiceDateController.value);
