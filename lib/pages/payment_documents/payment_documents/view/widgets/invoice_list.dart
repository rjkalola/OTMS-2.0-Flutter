...
class InvoiceList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => (controller.listInvoices.isNotEmpty &&
              controller.listInvoices[parentPosition].data != null)
          ? ListView.separated(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            getDetailRow(
                                'invoice_number'.tr, info.invoiceNumber),
                            getDetailRow('invoice_date'.tr, info.invoiceDate),
                            getDetailRow(
                                'period'.tr,
                                (!StringHelper.isEmptyString(info.fromDate) &&
              ...
              itemCount:
                  (controller.listInvoices[parentPosition].data ?? []).length,
