...
class PayslipDateList extends StatelessWidget {
  PayslipDateList({super.key, required this.searchText});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final filteredRecords = controller.listPayslips
          .map((record) {
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        PayslipList(parentPosition: index),
