...
class FormNumberFieldView extends StatefulWidget {
  const FormNumberFieldView({
    super.key,
    required this.field,
    this.isNested = false,
  });
  ...
  @override
  State<FormNumberFieldView> createState() => _FormNumberFieldViewState();
}

class _FormNumberFieldViewState extends State<FormNumberFieldView> {
  ...
  void _onTextChanged() {
    _controller.setNumberValue(_fieldId, _textController.text);
  }
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  isDense: true,
                  hintText: 'number_placeholder'.tr,
                  hintStyle: TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.w400,
