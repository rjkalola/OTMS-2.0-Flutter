...
class TextFieldVatNumber extends StatelessWidget {
  TextFieldVatNumber({super.key});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextFieldBorderDark(
        textEditingController: controller.vatNumberController.value,
        onFieldSubmitted: (value) {
          FocusScope.of(context).requestFocus(controller.focusNodeMainContracts.value);
        },
        hintText: 'vat_number'.tr,
