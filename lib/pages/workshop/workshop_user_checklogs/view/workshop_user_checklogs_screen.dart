...
import 'package:belcka/pages/workshop/workshop_user_checklogs/view/widgets/workshop_user_checklogs_list.dart';
...
class WorkshopUserChecklogsScreen extends StatefulWidget {
  const WorkshopUserChecklogsScreen({super.key});

  @override
  State<WorkshopUserChecklogsScreen> createState() =>
      _WorkshopUserChecklogsScreenState();
}

class _WorkshopUserChecklogsScreenState
    extends State<WorkshopUserChecklogsScreen> implements DateFilterListener {
  final controller = Get.put(WorkshopUserChecklogsController());
      ...
      () => Container(
        ...
        child: SafeArea(
          ...
          child: Scaffold(
            ...
            appBar: BaseAppBar(
              appBar: AppBar(),
              title: controller.userName.isNotEmpty
                  ? controller.userName
                  : 'check_in_'.tr,
              isCenterTitle: false,
              isBack: true,
              ...
              child: controller.isInternetNotAvailable.value
                  ? NoInternetWidget(
                      onPressed: () {
                        ...
                        controller.getWorkshopUserChecklogsApi(true);
                      },
                    )
                  : Visibility(
                      ...
                      child: Column(
                        children: [
                          ...
                          Expanded(child: WorkshopUserChecklogsList()),
                        ],
                      ),
                    ),
            ),
