          ...
          child: controller.isProductsLoading.value
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, catIndex) {
                    ...
                    final isLastCategory = catIndex == controller.categories.length - 1;
                    return Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            bool isAbsoluteLastItem = isLastCategory && (index == category.products.length - 1);

                            return Padding(
                              padding: EdgeInsets.only(bottom: isAbsoluteLastItem ? 90.0 : 0.0),
