...
class BillingApprovalButtonsView extends StatefulWidget {
  @override
  _BillingApprovalButtonsViewState createState() =>
      _BillingApprovalButtonsViewState();
}

class _BillingApprovalButtonsViewState
    extends State<BillingApprovalButtonsView> {
  final TextEditingController _noteController = TextEditingController();
  final controller = Get.put(BillingRequestController());
  final bool showActionCard =
      UserUtils.isAdmin(); //true; // Change to false for second scenario
  ...
  Widget build(BuildContext context) {
    return CardViewDashboardItem(
      ...
      child: showActionCard &&
              controller.billingRequestInfo.value.statusText == "pending"
          ? Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                if (showNoteSection) ...[
                  Text("do_you_want_to_leave_a_note".tr,
