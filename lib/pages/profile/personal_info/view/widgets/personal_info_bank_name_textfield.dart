...
class PersonalInfoBankNameTextFieldWidget extends StatelessWidget {
  PersonalInfoBankNameTextFieldWidget({super.key});
      ...
      children: [
        Flexible(
          ...
          child: TextFieldUnderline(
              ...
              textEditingController: controller.bankNameController.value,
