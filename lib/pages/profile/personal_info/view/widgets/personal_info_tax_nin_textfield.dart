...
class PersonalInfoTaxNINTextfieldWidget extends StatelessWidget {
  PersonalInfoTaxNINTextfieldWidget({super.key});
      ...
      children: [
        Flexible(
          ...
          child: TextFieldUnderline(
              ...
              textEditingController: controller.taxNINController.value,
              hintText: 'nin'.tr,
              labelText: 'nin'.tr,
