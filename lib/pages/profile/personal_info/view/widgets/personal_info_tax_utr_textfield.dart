...
class PersonalInfoTaxUTRTextfieldWidget extends StatelessWidget {
  PersonalInfoTaxUTRTextfieldWidget({super.key});
      ...
      children: [
        Flexible(
          ...
          child: TextFieldUnderline(
              ...
              textEditingController: controller.taxUTRController.value,
              hintText: 'utr'.tr,
              labelText: 'utr'.tr,
