...
class BillingDetailsNewScreen extends StatefulWidget {
  ...
  @override
  State<BillingDetailsNewScreen> createState() =>
      _BillingDetailsNewScreenState();
}
              ...
              body: ModalProgressHUD(
                ...
                child: controller.isInternetNotAvailable.value
                    ...
                    : Visibility(
                        ...
                        child: (controller.billingInfo.value.id ?? 0) != 0
                            ? Column(
                                children: [
                                  Expanded(
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              UserAvtarView(
                                                imageSize: 60,
                                                imageUrl: controller.billingInfo
                                                        .value.userThumbImage ??
                                                    "",
                                              ),
                                              SizedBox(height: 10),
                                              // Name
                                              Text(
                                                controller.billingInfo.value
                                                        .name ??
                                                    "",
                                                style: TextStyle(
                                                    fontSize: 24,
          ...
          child: Padding(
            ...
            child: ElevatedButton(
              onPressed: () {
                {
                  var arguments = {
                    AppConstants.intentKey.billingInfo:
                        controller.billingInfo.value,
                    AppConstants.intentKey.userId: controller.userId
                  };
                  controller.moveToScreen(
                      AppRoutes.billingInfoScreen, arguments);
                }
              },
